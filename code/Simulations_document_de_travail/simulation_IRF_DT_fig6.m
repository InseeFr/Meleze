...
%de la figure 6 du document de travail 
...
%% for figure 6a
      EULERGOV=[1];
      CALIBTYPE={'calib_CalibrationFR_EU_noEdgeworth','calib_CalibrationFR_EU_zeromu','calib_CalibrationFR_EU_zeromu_noEdgeworth'};                                 
      SIMULTYPE=[1]; 
      VARexo_stoch{1}={'e_ug1'; 1};

%% for figure 6b
       EULERGOV=[1];
       CALIBTYPE={'calib_CalibrationFR_EU_sigmac05','calib_CalibrationFR_EU_sigmac05_noEdgeworth','calib_CalibrationFR_EU_sigmac05_zeromu','calib_CalibrationFR_EU_sigmac05_zeromu_noEdgeworth'};
       SIMULTYPE=[1]; 
       VARexo_stoch{1}={'e_ug1'; 1};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
